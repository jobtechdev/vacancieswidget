    ...
    var main = function ($) {
        ...
        if ($afJobCount.length) {
            if(!$afJobCount[0].dataset.organisationsnummer) {
                ...
                httpRequestString = baseUrl + "matchning?organisationsnummer="+$afJobCount[0].dataset.organisationsnummer + "&lanid=" + $afJobCount[0].dataset.lanid + "&kommunid=" + $afJobCount[0].dataset.kommunid;
